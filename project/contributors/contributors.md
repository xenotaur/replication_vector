...
- Preserve the core mine, defend, replicate, and launch loop.
- Prefer small validated spikes before broad architecture or content expansion.
- Do not treat derived context files as authoritative requirements.
